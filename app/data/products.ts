...
function lampImages(slug: string) {
  return {
    imageOff: `/images/lamps/webp/${slug}-off.webp`,
    imageOn: `/images/lamps/webp/${slug}-on.webp`,
    thumbOff: `/images/lamps/thumbs/${slug}-off.webp`,
    thumbOn: `/images/lamps/thumbs/${slug}-on.webp`,
  };
}
