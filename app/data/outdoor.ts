...
function outdoorImages(slug: string) {
  return {
    imageOff: `/images/outdoor/webp/${slug}-off.webp`,
    imageOn: `/images/outdoor/webp/${slug}-on.webp`,
    thumbOff: `/images/outdoor/thumbs/${slug}-off.webp`,
    thumbOn: `/images/outdoor/thumbs/${slug}-on.webp`,
  };
}
